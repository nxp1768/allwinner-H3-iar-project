...
#define DMAC_CFG_DEST_TYPE_UART0			(6)
...
#define DMAC_CFG_SRC_TYPE_SPI0                          (23)
...
typedef struct
{
    ...
    unsigned int      reserved0        : 1;            //bit8 reserved
...
extern    int 			sunxi_dma_install_int(unsigned int hdma, interrupt_handler_t dma_int_func, void *p);
extern    int 			sunxi_dma_disable_int(unsigned int hdma);

extern    int 			sunxi_dma_enable_int(unsigned int hdma);
extern    int 			sunxi_dma_free_int(unsigned int hdma);
