...
#define SUNXI_FASTBOOT_DEVICE_PRODUCT					"Gt pen"  	/* 产品信息 	*/
#define SUNXI_FASTBOOT_DEVICE_SERIAL_NUMBER				"20080411"  			/* 产品序列号 	*/
#define SUNXI_FASTBOOT_DEVICE_CONFIG        			"HID DEVICE"
...
#define	  DEVICE_VENDOR_ID  					0x123
#define	  DEVICE_PRODUCT_ID 					0x0123
#define	  DEVICE_BCD        					0xffff
