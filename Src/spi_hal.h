...
#define SPI_DEFAULT_CLK	        (20000000)
#define SPI_TX_WL		(0x04)
#define SPI_RX_WL		(0x04)
#define SPI_FIFO_SIZE	(64/2)
#define SPI_CLK_SRC		(1)	//0-24M, 1-PLL6
#define SPI_MCLK		(100000000)
...
typedef struct
{    
    unsigned int SPI_VAR_R;		//(SPI_BASE + 0x00)
    unsigned int SPI_GCR_WR;		//(SPI_BASE + 0x04)
    unsigned int SPI_TCR_WR;		//(SPI_BASE + 0x08)
    unsigned int reser0[1];//
    unsigned int SPI_IER_WR;		//(SPI_BASE + 0x10)
    unsigned int SPI_ISR_WR;		//(SPI_BASE + 0x14)
    unsigned int SPI_FCR_WR;		//(SPI_BASE + 0x18)
    unsigned int SPI_FSR_R;		///(SPI_BASE + 0x1c)
    unsigned int SPI_WCR_WR;		//(SPI_BASE + 0x20)
    unsigned int SPI_CCR_WR;		//(SPI_BASE + 0x24)
    unsigned int reser1[2];//
    unsigned int SPI_MBC_WR;		//(SPI_BASE + 0x30)
    unsigned int SPI_MTC_WR;		//(SPI_BASE + 0x34)
    unsigned int SPI_BCC_WR;		//(SPI_BASE + 0x38) 
} SPI_REG;
